...
export interface UpdateApplicantStatusAdmin {
  /** Status */
  status: number;
}

export interface FacultyAdd {
  /**
   * Название
   * @minLength 1
   * @maxLength 100
...
export interface SpecializationAdd {
  /**
   * Название
   * @minLength 1
   * @maxLength 100
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  applicants = {
     ...
     * @secure
     */
    applicantsUpdateStatusAdminUpdate: (
      applicantId: string,
      data: UpdateApplicantStatusAdmin,
      params: RequestParams = {},
    ) =>
      this.request<UpdateApplicantStatusAdmin, any>({
  ...
  faculties = {
     ...
     *
     * @tags faculties
     * @name FacultiesCreateCreate
     * @request POST:/faculties/create/
     * @secure
     */
    facultiesCreateCreate: (
      data: {
        /**
         * @minLength 1
         * @maxLength 100
  ...
  specializations = {
    ...
    specializationsCreateCreate: (
      ...
      this.request<SpecializationAdd, any>({
     ...
     * @secure
     */
    specializationsUpdateUpdate: (specializationId: string, data: Specialization, params: RequestParams = {}) =>
      this.request<Specialization, any>({
     ...
     * @secure
     */
    specializationsUpdateImageCreate: (
      specializationId: string,
      data: {
        /** @format binary */
        image?: File;
